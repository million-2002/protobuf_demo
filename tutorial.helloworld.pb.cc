...
#include "tutorial.helloworld.pb.h"
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_tutorial_2ehelloworld_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_tutorial_2ehelloworld_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_tutorial_2ehelloworld_2eproto = nullptr;

const uint32_t TableStruct_tutorial_2ehelloworld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::tutorial::helloworld, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::tutorial::helloworld, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::tutorial::helloworld, id_),
  PROTOBUF_FIELD_OFFSET(::tutorial::helloworld, str_),
  PROTOBUF_FIELD_OFFSET(::tutorial::helloworld, opt_),
  1,
  0,
  2,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::tutorial::helloworld)},
};
...
const char descriptor_table_protodef_tutorial_2ehelloworld_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\031tutorial.helloworld.proto\022\010tutorial\"2\n"
  "\nhelloworld\022\n\n\002id\030\001 \002(\005\022\013\n\003str\030\002 \002(\t\022\013\n\003"
  "opt\030\003 \001(\005"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_tutorial_2ehelloworld_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tutorial_2ehelloworld_2eproto = {
  false, false, 89, descriptor_table_protodef_tutorial_2ehelloworld_2eproto, "tutorial.helloworld.proto", 
  &descriptor_table_tutorial_2ehelloworld_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_tutorial_2ehelloworld_2eproto::offsets,
  file_level_metadata_tutorial_2ehelloworld_2eproto, file_level_enum_descriptors_tutorial_2ehelloworld_2eproto, file_level_service_descriptors_tutorial_2ehelloworld_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_tutorial_2ehelloworld_2eproto_getter() {
  return &descriptor_table_tutorial_2ehelloworld_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_tutorial_2ehelloworld_2eproto(&descriptor_table_tutorial_2ehelloworld_2eproto);
namespace tutorial {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "tutorial.helloworld.str");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else
          goto handle_unusual;
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:tutorial.helloworld)
  size_t total_size = 0;
...
::PROTOBUF_NAMESPACE_ID::Metadata helloworld::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_tutorial_2ehelloworld_2eproto_getter, &descriptor_table_tutorial_2ehelloworld_2eproto_once,
      file_level_metadata_tutorial_2ehelloworld_2eproto[0]);
}
